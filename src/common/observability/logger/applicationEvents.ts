...
/**
 * Missing parsed data event
 *
 * Fired when Analyser agent completes but parsedData is unexpectedly undefined.
 * This indicates parser tools may not have run or may have cleared data.
 */
export const MissingParsedDataEventSchema = PinoLogBaseSchema.extend({
	event: z.literal('missing_parsed_data'),
	data: z.object({}).optional(),
});

export type MissingParsedDataEvent = z.infer<typeof MissingParsedDataEventSchema>;
