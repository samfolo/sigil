 ...
 * via the `definition` "DataShape".
 */
export type DataShape = "tabular" | "hierarchical" | "key_value" | "graph" | "geospatial";
/**
 ...
 *
 * This interface was referenced by `ComponentSpec`'s JSON-Schema
 * via the `definition` "StackLayoutNode".
 */
 ...
 *
 * This interface was referenced by `ComponentSpec`'s JSON-Schema
 * via the `definition` "LayoutChild".
 */
export type LayoutChild = LayoutLayoutChild | ComponentLayoutChild;
/**
 ...
 *
 * This interface was referenced by `ComponentSpec`'s JSON-Schema
 * via the `definition` "LayoutNodeSpacing".
 */
 ...
 *
 * This interface was referenced by `ComponentSpec`'s JSON-Schema
 * via the `definition` "StackLayoutNodeAlignment".
 */
 ...
 *
 * This interface was referenced by `ComponentSpec`'s JSON-Schema
 * via the `definition` "ComponentConfig".
 */
export type ComponentConfig = DataTableConfig | HierarchyConfig | CompositionConfig | TextInsightConfig;
/**
 ...
 *
 * This interface was referenced by `ComponentSpec`'s JSON-Schema
 * via the `definition` "FilterCondition".
 */
 ...
 *
 * This interface was referenced by `ComponentSpec`'s JSON-Schema
 * via the `definition` "FilterConditionLogicalOperator".
 */
 ...
 *
 * This interface was referenced by `ComponentSpec`'s JSON-Schema
 * via the `definition` "ExportAffordanceFormat".
 */
 ...
 */
export type ComponentType = "data-table" | "hierarchy" | "composition" | "text-insight";
/**
